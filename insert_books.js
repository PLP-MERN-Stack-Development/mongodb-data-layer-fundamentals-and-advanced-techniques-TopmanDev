// insert_books.js
// This script inserts sample book data into the MongoDB 'plp_bookstore' database.
// If the collection already exists, it will drop it first to avoid duplicates.
...
async function insertBooks() {
  ...
  try {
    ...
    if (count > 0) {
      ...
      await collection.drop(); // Remove existing documents
    ...
    // Display inserted books in terminal
